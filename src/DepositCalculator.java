/*
В общем, мне все наравится. Все "по-полочкам", имена понятные, отступы в 4 пробела)). 
Возможно только я бы в операторе if на 32 строке завернул его результат в фигурные скобки, т.к. в else if они есть, 
тем самым привести к общему виду. Ну, либо убрать из else if. Но, вроде, в теории говорилось, что скобки нужны всегда. 
*/
